      ...
      <div className="pt-24 px-4 pb-6 min-h-screen flex flex-col items-center justify-center md:pt-32">
        <div className="w-full max-w-sm md:max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">Welcome to MAF</h1>
            ...
            <div className="space-y-6 md:space-y-8">
              <div className="group">
                <div className="mb-3 text-center">
                  ...
                  <p className="text-slate-300 text-xs md:text-sm opacity-80">Ready to learn boxing?</p>
                </div>
                <PrimaryButton
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs md:text-sm">
                  <span className="px-3 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-slate-400">or</span>
                </div>
              </div>
              ...
              <div className="group">
                <div className="mb-3 text-center">
                  ...
                  <p className="text-slate-300 text-xs md:text-sm opacity-80">Ready to teach boxing?</p>
                </div>
                <PrimaryButton
